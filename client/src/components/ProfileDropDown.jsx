...
const UserProfileOptionsMenu = () => {
  ...
  let buttonStyle = "flex px-7 py-3 items-center  rounded-md text-md font-medium text-blue-800 hover:outline outline-1 ";
