...
const UserProfileOptionsMenu = () => {
  ...
  let buttonStyle = "flex px-5 py-2 items-center rounded-md text-xs font-medium text-blue-800 hover:outline outline-1 ";
