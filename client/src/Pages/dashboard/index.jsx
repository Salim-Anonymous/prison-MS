    ...
    return <div className="flex flex-col justify-between z-2">
        ...
        <div className="grid grid-cols-3 gap-x-20 mt-8 2xl:grid-cols-4">
            {links.map((link,index) => {
                return <div key={link.name+index} className="flex flex-row justify-between py-3 px-5 m-2 text-2xl text-white bg-blue-800 rounded-lg shadow-md hover:bg-black hover:cursor-pointer">
